  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 transition-colors duration-300 bg-slate-50 text-slate-900 dark:bg-[#0B111E] dark:text-white">
      ...
      <motion.div
        ...
        className="w-full max-w-md rounded-3xl shadow-2xl border p-8 md:p-10 transition-colors duration-300 bg-white border-slate-200 dark:bg-[#111827] dark:border-slate-800"
      >
        {/* header */}
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="w-full bg-[#0071E3] hover:bg-[#005BB5] text-white py-3 rounded-xl font-semibold transition"
        >
          Sign In
        </motion.button>
        ...
        <motion.button
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.97 }}
          className="w-full border py-3 rounded-xl flex items-center justify-center gap-3 transition bg-white border-slate-200 hover:bg-slate-50 text-slate-900 dark:bg-[#0B111E] dark:border-slate-800 dark:hover:bg-slate-800 dark:text-white"
        >
